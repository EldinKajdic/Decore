...
namespace DecoreLogin.StudentServiceReference {
    ...
    public interface IStudentService {
        ...
        DecoreLogin.StudentServiceReference.StudentInfo CreateStudent(DecoreLogin.StudentServiceReference.StudentInfo student);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStudentService/CreateStudent", ReplyAction="http://tempuri.org/IStudentService/CreateStudentResponse")]
        System.Threading.Tasks.Task<DecoreLogin.StudentServiceReference.StudentInfo> CreateStudentAsync(DecoreLogin.StudentServiceReference.StudentInfo student);
        ...
        DecoreLogin.StudentServiceReference.StudentInfo GetStudentByUserId(int user_Id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStudentService/GetStudentByUserId", ReplyAction="http://tempuri.org/IStudentService/GetStudentByUserIdResponse")]
        System.Threading.Tasks.Task<DecoreLogin.StudentServiceReference.StudentInfo> GetStudentByUserIdAsync(int user_Id);
        ...
        DecoreLogin.StudentServiceReference.StudentInfo[] GetAllStudents();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStudentService/GetAllStudents", ReplyAction="http://tempuri.org/IStudentService/GetAllStudentsResponse")]
        System.Threading.Tasks.Task<DecoreLogin.StudentServiceReference.StudentInfo[]> GetAllStudentsAsync();
        ...
        DecoreLogin.StudentServiceReference.StudentInfo UpdateStudent(DecoreLogin.StudentServiceReference.StudentInfo updatedStudent);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStudentService/UpdateStudent", ReplyAction="http://tempuri.org/IStudentService/UpdateStudentResponse")]
        System.Threading.Tasks.Task<DecoreLogin.StudentServiceReference.StudentInfo> UpdateStudentAsync(DecoreLogin.StudentServiceReference.StudentInfo updatedStudent);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IStudentServiceChannel : DecoreLogin.StudentServiceReference.IStudentService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class StudentServiceClient : System.ServiceModel.ClientBase<DecoreLogin.StudentServiceReference.IStudentService>, DecoreLogin.StudentServiceReference.IStudentService {
        ...
        public System.Threading.Tasks.Task<DecoreLogin.StudentServiceReference.StudentInfo> CreateStudentAsync(DecoreLogin.StudentServiceReference.StudentInfo student) {
            return base.Channel.CreateStudentAsync(student);
        }
        
        public DecoreLogin.StudentServiceReference.StudentInfo GetStudentByUserId(int user_Id) {
            return base.Channel.GetStudentByUserId(user_Id);
        }
        
        public System.Threading.Tasks.Task<DecoreLogin.StudentServiceReference.StudentInfo> GetStudentByUserIdAsync(int user_Id) {
            return base.Channel.GetStudentByUserIdAsync(user_Id);
        }
        
        public DecoreLogin.StudentServiceReference.StudentInfo[] GetAllStudents() {
            return base.Channel.GetAllStudents();
        }
        
        public System.Threading.Tasks.Task<DecoreLogin.StudentServiceReference.StudentInfo[]> GetAllStudentsAsync() {
